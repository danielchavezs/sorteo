...
export default function SuccessResult ({ code }: { code: String}){
    return (
        <div className="flex flex-col w-full lg:w-96 lg:min-h-full md:min-h-52 md:f-full sm:min-h-full bg-teal-900 p-8 lg:pb-0 sm:pb-14 rounded-bl-5xl lg:rounded-r-2xl md:rounded-b-2xl md:rounded-t-none sm:rounded-none place-content-center">
          <div className="space-y-20">
            ...
            <div className="border-b-0 border-x-0 border-2 border-customGreen shadow-md shadow-slate-800 p-6 rounded-md">
