...
export default function EmptyResult(){
    return (
      <div className="flex flex-col justify-center w-full lg:w-96 min-h-full bg-slate-900 p-8 lg:rounded-r-2xl md:rounded-b-2xl md:rounded-t-none sm:rounded-none rounded-bl-5xl">
        <div className="flex lg:flex-col md:flex-row sm:flex-col h-full lg:space-y-20 lg:space-x-0 md:space-y-0 sm:space-y-10 md:space-x-8 md:min-h-52 md:place-content-between items-center">
